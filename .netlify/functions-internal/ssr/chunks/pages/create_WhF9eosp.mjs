/* empty css                           */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as renderComponent, s as spreadAttributes, f as addAttribute, g as renderHead, h as renderSlot } from '../astro_HRyy38CH.mjs';
...
const CreateNewsForm = () => {
  ...
  async function generateSignedUrl(fileName) {
    try {
      const { data, error } = await supabase.storage.from("news_images").createSignedUrl(fileName, expiryTime);
      if (error) {
        throw error;
      }
      if (data) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      let imageURL = "";
      if (imageFile) {
        const { data: imageData, error: imageError } = await supabase.storage.from("news_images").upload(`${imageFile.name}`, imageFile, { cacheControl: "3600" });
        if (imageError) {
          throw imageError;
        }
        if (imageData) {
      ...
      const { error } = await supabase.from("news_articles").insert([{ title, description, body, date_published: datePublished, images: imageURL }]);
      if (error) {
        throw error;
      }
      setTitle("");
  ...
  return /* @__PURE__ */ jsx("div", { className: "container mx-auto p-4 m-10 bg-gray-100 border border-black rounded", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap", children: /* @__PURE__ */ jsxs("div", { className: "w-full md:w-1/2 p-10", children: [
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "max-w-lg", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "newsImage", className: "block text-gray-700 font-bold", children: "News Image:" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "file",
...
export { $$Navigation as $, Button as B, $$Sidebar as a, $$NewsLayout as b, create as c };
