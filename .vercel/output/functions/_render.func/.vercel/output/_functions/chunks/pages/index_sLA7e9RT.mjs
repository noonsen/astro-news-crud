...
import { s as supabase, $ as $$Navigation, a as $$Sidebar } from './create_ZaFRnUQO.mjs';
import 'clsx';
...
const UpdateModal = ({ id }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("button", { onClick: handleOpenModal, className: " flex px-3 py-2 font-semibold bg-blue-400 rounded-lg hover:transition-transform hover:scale-110 active:translate-y-1 p-1", children: [
    ...
    showModal && /* @__PURE__ */ jsx("div", { className: "fixed top-0 left-0 z-50 h-screen w-full flex justify-center items-center backdrop-filter backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-5 w-80 active:bg-blur rounded-lg shadow-lg border border-black ", children: [
...
const $$Cards = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="container mx-auto p-6 z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2"> ${cards.sort((a, b) => new Date(a.date_published).getTime() - new Date(b.date_published).getTime()).map((card) => renderTemplate`${renderComponent($$result, "Card", $$Card, { ...card })}`)} </div>`;
